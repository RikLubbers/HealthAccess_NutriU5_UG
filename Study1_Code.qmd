...
list.functions.in.file(filename = "D:/Onedrive/PhD_Undernutrition_Uganda_Physical_Accessbility/0_code/PhD-Code/Study_1/R_script_thesis.qmd", alphabetic = TRUE)
```
...
Travel_time_clust = read_xls("C:/Users/Rik/OneDrive/PhD_Undernutrition_Uganda_Physical_Accessbility/1_Study_1_Physical_access/Data/DATA/Uganda Full/Analyses/Travel_time.xls", col_names = TRUE)
...
# Bar plot of travel time categories by urban/rural type
ggplot(Travel_time_clust) +
...
modelsummary((pool(modeltest)), stars = TRUE, coef_rename = T)
