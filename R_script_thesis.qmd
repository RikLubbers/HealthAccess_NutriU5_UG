...
DHS_children_sub <- read_sav("D:/Onedrive/PhD_Undernutrition_Uganda_Physical_Accessbility/1_Study_1_Physical_access/Data/DATA/Uganda Full/DHS Clusters/UGKR7BSV_Children/UGKR7BFL.SAV") %>%
  select(
    CASEID, V001, V005, V023, V024, V149, V729, V191, V212, V445, V714,
    BIDX, B0, B4, B5, BORD, HW5, HW8, HW11, M19, B11, H11, V113, M5, V136,
    V481, H22, V505, H7
  )

# Read the travel time data
Travel_time_clust <- read_xls("D:/Onedrive/PhD_Undernutrition_Uganda_Physical_Accessbility/1_Study_1_Physical_access/Data/DATA/Uganda Full/Analyses/Travel_time.xls", col_names = TRUE)

# Merge the data
DHS_children_sub <- DHS_children_sub %>%
  left_join(Travel_time_clust, by = c("V001" = "DHSCLUST"))
