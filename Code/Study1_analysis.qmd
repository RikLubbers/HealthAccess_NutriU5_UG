...
required_packages <- c(
  ...
  "languageserver", "httpgd", "miceadds", "ggmice", "howManyImputations"
)
...
C:\Users\Rik\OneDrive\PhD_Undernutrition_Uganda_Physical_Accessbility\1_Study_1_Physical_access\Data\DATA\Uganda Full\Travel_Time
...
Travel_time_clust = read_xls("C:/Users/Rik/OneDrive/PhD_Undernutrition_Uganda_Physical_Accessbility/1_Study_1_Physical_access/Data/DATA/Uganda Full/Travel_Time/Travel_time.xls",      
  col_names = TRUE)
...
table1_stunted = table1(~ B4 + BORD + B0 + M19 + B11 + H11 + H22 + H7 + V481 + V149 + V729 + V505 + V191 + V212 + V445 + V714 + V113 + V136 + travel_time | HW5_cat
...
table1_wasted = table1(~ B4 + BORD + B0 + M19 + B11 + H11 + H22 + H7 + V481 + V149 + V729 + V505 + V191 + V212 + V445 + V714 + V113 + V136 + travel_time | HW11_cat,
  data=DHS_children_sub,
  topclass="Rtable1-zebra"
)
...
table1_underweight = table1(~ B4 + BORD + B0 + M19 + B11 + H11 + H22 + H7 + V481 + V149 + V729 + V505 + V191 + V212 + V445 + V714 + V113 + V136 + travel_time | HW8_cat,
  data=DHS_children_sub,
  topclass="Rtable1-zebra"
)
...
## Two-step recipe for imputation, first we do a pilot analysis with 20 imputations and then we calculate the number of imputations needed (see # MICE models unweighted))
### MaxIt already converged at 5 iterations
...
glm_stunted = stepAIC(glm_stunted, 
  direction = "both"
)
...
## Stepwise model selection using AIC
glm_underweight = stepAIC(glm_underweight, 
direction = "both"
)
...
```{r Model comparison MICE Pooled unweighted}
# Comparing Models for Stunting, Wasting, and Underweight with or without pooling and MICE
## Stunting  
MICE_model_stunt = with(DHS_children_sub_multimp, 
...
## Wasting
MICE_model_wast = with(DHS_children_sub_multimp, 
...
## Underweight
MICE_model_underweight= with(DHS_children_sub_multimp, 
...
## MICE models
MICEmodels = modelsummary(list(MICE_model_stunt, MICE_model_wast, MICE_model_underweight), 
  stars = TRUE, 
  coef_rename = T, 
  col.names=c("", "Stunting", "Wasting", "Underweight")
)
...
# Model creation
## Stunting  
MICE_model_stunt_weight = with(DHS_children_sub_multimp_weighted, 
  lm(HW5 ~ B4 + BORD + M19 + B11 + H11 + H22 + V481 + V729 + V505 + V191 + V212 + V445 + V714 + V113 + V136 + M5 + H7 + travel_time)
)
...
## Wasting
MICE_model_wast_weight = with(DHS_children_sub_multimp_weighted, 
  lm(HW11 ~ B4 + BORD + M19 + B11 + H11 + H22 + V481 + V729 + V505 + V191 + V212 + V445 + V714 + V113 + V136 + M5 + H7 + travel_time,)
)
...
MICE_model_underweight_weight = 
  with(DHS_children_sub_multimp_weighted, 
  lm(HW8 ~ B4 + BORD + M19 + B11 + H11 + H22 + V481 + V729 + V505 + V191 + V212 + V445 + V714 + V113 + V136 + M5 + H7 + travel_time,)
)
