...
Travel_time_clust = read_xls("D:/Onedrive/PhD_Undernutrition_Uganda_Physical_Accessbility/1_Study_1_Physical_access/Data/DATA/Uganda Full/Travel_Time/Travel_time.xls" , col_names = TRUE)
...
table1_underweight = table1(
  ~ B4 + BORD + B0 + M19 + B11 + H11 + H22 + V481 +  V149 + V729 + V505 + V191 + V212 + V445 + V714 + V113 + V136 + M5 + H7 + travel_time | HW8_cat, data=DHS_children_sub, 
  topclass="Rtable1-zebra", 
  extra.col=list(`P-value`=signif_stars), 
  overall=F
)
...
ggplot(Travel_time_clust) +
  ...
  geom_text(stat = 'count', aes(label = paste0("N = ", ..count..)), vjust = 2, size = 8) +
  geom_text(stat = 'count', aes(label = scales::percent(..count.. / 677)), vjust = 3.5, size = 8)
